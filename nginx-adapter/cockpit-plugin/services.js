...
(function() {
    ...
    var WHITELIST = [
        ...
        { name: "duckdns-update.timer", label: "DuckDNS Update Timer" },
        { name: "packagekit", label: "PackageKit" }
    ];
    var NO_DISABLE = SM.PROTECTED_SERVICES || ["ssh", "ufw", "duckdns-update.timer"];
    var WARN_STOP = ["nginx", "ssh", "ufw", "docker"];
